...
for j=1:size(e4s,1)
    ...
    B(ind4s(j,:,1),(j-1)*(N+1)+(1:N+1))=B(ind4s(j,:,1),(j-1)*(N+1)+(1:N+1))-(h/2)*M*(k/h);
    B(ind4s(j,:,2),(j-1)*(N+1)+(1:N+1))=B(ind4s(j,:,2),(j-1)*(N+1)+(1:N+1))-(h/2)*M*(k/h);
    else
        n=normal(c4n2(ind4s(j,N+1,1),:)-c4n2(ind4s(j,1,1),:));
        h=norm(c4n(n4s(j,2),:)-c4n(n4s(j,1),:));
        M=I1D/(V1D*V1D');
...
for j=1:size(e4s,1)
    ...
    C((j-1)*(N+1)+(1:N+1),ind4s(j,:,1))=C((j-1)*(N+1)+(1:N+1),ind4s(j,:,1))-(h/2)*M*(k/h);
    C((j-1)*(N+1)+(1:N+1),ind4s(j,:,2))=C((j-1)*(N+1)+(1:N+1),ind4s(j,:,2))-(h/2)*M*(k/h);
    else
        n=normal(c4n2(ind4s(j,N+1,1),:)-c4n2(ind4s(j,1,1),:));
        h=norm(c4n(n4s(j,2),:)-c4n(n4s(j,1),:));
        M=I1D/(V1D*V1D');
...
for j=1:size(e4s,1)
    ...
    D((j-1)*(N+1)+(1:N+1),(j-1)*(N+1)+(1:N+1))=D((j-1)*(N+1)+(1:N+1),(j-1)*(N+1)+(1:N+1))+(h/2)*(k/h)*M;
end
